  ...
  function sendComment(e) {
   ...
   // dispatch(
    ...
    //      userFullname:
     ...
     // })
    //);
    dispatch(addComment({postId:postId,newComment:{content:commentContent}}));
    setCommentContent("");
  }
  }
      ...
      <Row>
        ...
        <div className="d-flex justify-content-center align-items-center">
          ...
          <div className="mx-3">
            ...
            <span>
              {props.loveList !== null && props.loveList !=="" ? props.loveList : null}
            </span>
          </div>
              ...
              <div className="border rounded border-info my-3 px-2 pb-2">
                <div className="d-flex align-items-center my-2">
                  ...
                  <div className="w-100 mx-1 fw-bold">
                    <span>{commentItem.user ? commentItem.user.username:'ananymous'}</span>
                    <span>({commentItem.postDate?timeAgo.format(new Date(commentItem.postDate).getTime()):'1 hour ago'})</span>
                  </div>
                </div>
                <div>{commentItem.tweetTag}</div>
              </div>
            ))):(<span></span>)}
          </div>
        ) : (
